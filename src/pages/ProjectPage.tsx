    ...
    return (
      <main className="min-h-screen bg-slate-950 px-6 py-16 text-white">
        <div className="mx-auto max-w-3xl card p-8 text-center">
          ...
          <p className="mt-3 text-slate-300">This mission is not active yet.</p>
          <Link className="btn-primary mt-6 inline-block" to="/student/worlds">Back to Worlds</Link>
        </div>
      </main>
    );
  }

  return <MissionEngine project={project} />;
}
